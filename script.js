...
function handleSubmit(e) {
  ...
  if (
    ...
    alert("Welcome to Spark's Family, You are now our user");
...
// landingpg.html program

const indexpage = document.querySelector(".hero-box");
const landingpgBack = document.querySelector(".landingpg_container");
...
function loginPage() {
  if (!signupForm.classList.contains("hidden")) {
    ...
    loginForm.classList.toggle("hidden");
    if (indexPage != null) {
      indexPage.classList.toggle("blur");
      landingpgBack.classList.toggle("hideindexContent");
    } else if (aboutPage != null) {
      aboutPage.classList.toggle("blur");
    }
  }
